...
//Name: banana.ma
//Last modified: Tue, Nov 20, 2012 04:26:31 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	...
	setAttr ".r" -type "double3" 7.4616472705832493 31.399999999890785 0 ;
...
createNode polyExtrudeFace -n "pasted__polyExtrudeFace6";
	...
	setAttr ".rs" 40722;
	setAttr ".lt" -type "double3" -3.7470027081099033e-16 -4.7184478546569153e-16 1.2186181518330372 ;
	setAttr ".c[0]"  0 1 1;
...
createNode polyExtrudeFace -n "pasted__polyExtrudeFace5";
	...
	setAttr ".rs" 35051;
	setAttr ".lt" -type "double3" -1.7763568394002505e-15 -5.8841820305133297e-15 3.181840010348592 ;
	setAttr ".c[0]"  0 1 1;
...
createNode polyExtrudeFace -n "pasted__polyExtrudeFace4";
	...
	setAttr ".rs" 50344;
	setAttr ".lt" -type "double3" 1.0408340855860845e-16 5.5511151231257827e-16 1.2006551464132285 ;
	setAttr ".c[0]"  0 1 1;
...
createNode polyTweak -n "pasted__polyTweak2";
	...
	setAttr -s 70 ".tk[0:69]" -type "float3"  0.021638788 0.044450007 -0.057669107
		 ...
		 -0.38033038 -0.14763916 0.0096287876 0.17306024 -0.064572468 -7.4361524e-05 0.076642022
		 0.022220872 -7.4370881e-05 0.096452072 0.1275533 -0.0026537678 0.2014271 0.060681731
		 -0.0047823265 -0.19192722 0.027690716 -0.0046963375 -0.08143115 -0.087690786 -0.0005796717
		 -0.18885489 -0.040171217 0.0034826961 0.28415492 -0.064066 5.1809795e-05 0.077212863
		 0.022305125 5.1809719e-05 0.09692654 0.12347303 -0.0010997391 0.18564475 0.058818027
...
createNode polyExtrudeFace -n "pasted__polyExtrudeFace3";
	...
	setAttr ".rs" 43580;
	setAttr ".lt" -type "double3" 8.7603535536828758e-17 1.2212453270876722e-15 0.96467138656478335 ;
	setAttr ".c[0]"  0 1 1;
...
createNode polyExtrudeFace -n "pasted__polyExtrudeFace2";
	...
	setAttr ".rs" 46119;
	setAttr ".lt" -type "double3" -4.6837533851373792e-17 3.3306690738754696e-16 1.3635332823558886 ;
	setAttr ".c[0]"  0 1 1;
...
createNode polyTweakUV -n "polyTweakUV2";
	...
	setAttr ".uvtk[70]" -type "float2" 9.3132257e-09 -0.010698976 ;
	setAttr ".uvtk[73]" -type "float2" 0.0025174101 -0.023915444 ;
	setAttr ".uvtk[74]" -type "float2" 0 -0.009440287 ;
createNode blinn -n "blinn1";
	setAttr ".c" -type "float3" 0.83200002 0.77719897 0 ;
...
connectAttr "BananaShapeShape.iog" "blinn1SG.dsm" -na;
