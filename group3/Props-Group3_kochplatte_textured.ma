...
//Last modified: Wed, Nov 07, 2012 03:14:28 PM
//Codeset: UTF-8
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.2548353144228379 5.7827953604349878 0.018342910080084457 ;
	setAttr ".r" -type "double3" -47.738352729808724 89.799999999989751 0 ;
	setAttr ".rp" -type "double3" 0 7.1054273576010019e-15 0 ;
	setAttr ".rpt" -type "double3" -9.5402638029936296e-17 3.6967995612096388e-16 5.5571800645702279e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 7.81372848419461;
...
createNode mesh -n "right_plateShape" -p "right_plate";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.79670122265815724 0.35509860515594482 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode polyCylinder -n "polyCylinder2";
	setAttr ".sc" 1;
	setAttr ".cuv" 3;
createNode blinn -n "kochplatte1";
...
connectAttr "file1.oc" "kochplatte1.c";
connectAttr "file1.ot" "kochplatte1.it";
connectAttr "kochplatte1.oc" "blinn1SG.ss";
...
connectAttr "kochplatte1.msg" "materialInfo1.m";
...
connectAttr "kochplatte1.msg" ":defaultShaderList1.s" -na;
