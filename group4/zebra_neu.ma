...
//Name: zebra_neu.ma
//Last modified: Sun, Nov 04, 2012 03:17:34 PM
//Codeset: 1252
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".t" -type "double3" 3.599567891309805 2.1303094829957927 1.7399356269681134 ;
	setAttr ".r" -type "double3" -16.538341123180306 2254.1999999988707 -2.5444437451708134e-014 ;
	setAttr ".rp" -type "double3" 3.3306690738754696e-016 0 0 ;
	setAttr ".rpt" -type "double3" -3.0581278105844084e-014 7.0510630463607228e-015 
		1.9842284994449167e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 3.896398836295154;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.13586448140844931 1.3332521463376961 0.85497510275420607 ;
...
createNode transform -s -n "front";
	setAttr ".t" -type "double3" -1.445047737136493e-014 0.59520136117936762 0.94241969837688155 ;
	setAttr ".rpt" -type "double3" 1.4270172657666e-014 -1.5757466668415141e-014 -2.8413790889449854e-014 ;
createNode camera -s -n "frontShape" -p "front";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 0.81201939835091319;
	setAttr ".ow" 5.290857027883594;
	setAttr ".imn" -type "string" "front";
	setAttr ".den" -type "string" "front_depth";
	setAttr ".man" -type "string" "front_mask";
	setAttr ".tp" -type "double3" -1.8030471369893011e-016 0.59520136117935185 0.13040030002593994 ;
...
createNode imagePlane -n "imagePlaneShape2" -p "|front|frontShape->|imagePlane1";
	...
	setAttr ".dlc" no;
	setAttr ".ic" -type "double3" -0.037460316831331664 1.5 0 ;
	setAttr ".w" 2.25;
	setAttr ".h" 3;
createNode transform -s -n "side";
	setAttr ".t" -type "double3" 0.47810888701038551 1.0514547123170448 1.6984453842864111 ;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".ow" 0.80201716056428418;
...
createNode imagePlane -n "imagePlaneShape1" -p "|side|sideShape->|imagePlane1";
	...
	setAttr ".dlc" no;
	setAttr ".ic" -type "double3" 0.0060262220204805317 0.6 0.4 ;
	setAttr ".w" 3.5;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr -s 13 ".pt";
	setAttr ".pt[119]" -type "float3" 0 0.00015650154 0.0414933 ;
	setAttr ".pt[120]" -type "float3" 0 0.011015153 -0.043187667 ;
	setAttr ".pt[121]" -type "float3" 0 0.008129226 -0.076039501 ;
	setAttr ".pt[122]" -type "float3" 0 -0.0064713685 -0.067882262 ;
	setAttr ".pt[123]" -type "float3" 0 -0.027505998 -0.037419543 ;
	setAttr ".pt[124]" -type "float3" 0 -0.049303468 0.018380972 ;
