...
//Name: zebra_neu_body.ma
//Last modified: Sun, Nov 04, 2012 01:55:26 PM
//Codeset: 1252
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".t" -type "double3" 1.5941050856601071 2.6934593526667836 2.4909259983830387 ;
	setAttr ".r" -type "double3" -29.738341131814703 46.599999997318385 0 ;
...
createNode transform -s -n "side";
	setAttr ".t" -type "double3" 0.47810888701038556 1.3652392483099827 1.1907849233462326 ;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".pt[36]" -type "float3" 0 0 -5.9604645e-008 ;
	...
	setAttr ".pt[112]" -type "float3" 0 0 -5.9604645e-008 ;
	setAttr ".pt[113]" -type "float3" 0 0 2.682209e-007 ;
	setAttr ".pt[114]" -type "float3" 0 0 2.682209e-007 ;
	setAttr ".pt[115]" -type "float3" 0 0 2.682209e-007 ;
	setAttr ".pt[116]" -type "float3" 0 0 2.682209e-007 ;
	setAttr ".pt[117]" -type "float3" 0 0 2.682209e-007 ;
	setAttr ".pt[118]" -type "float3" 0 0 2.682209e-007 ;
	setAttr ".dr" 1;
...
createNode script -n "uiConfigurationScriptNode";
	setAttr ".b" -type "string" (
		...
		+ "\t\t\tpanelConfiguration -edit -label (localizedPanelLabel(\"Current Layout\")) \n\t\t\t\t-defaultImage \"\"\n\t\t\t\t-image \"\"\n\t\t\t\t-sc false\n\t\t\t\t-configString \"global string $gMainPane; paneLayout -e -cn \\\"quad\\\" -ps 1 59 50 -ps 2 41 50 -ps 3 50 50 -ps 4 50 50 $gMainPane;\"\n\t\t\t\t-removeAllPanels\n\t\t\t\t-ap false\n\t\t\t\t\t(localizedPanelLabel(\"Top View\")) \n\t\t\t\t\t\"modelPanel\"\n"
...
connectAttr "deleteComponent68.og" "|pCube1|pCubeShape1.i";
