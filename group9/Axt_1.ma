...
//Name: Axt_1.ma
//Last modified: Tue, Oct 23, 2012 06:31:14 PM
//Codeset: 1252
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".t" -type "double3" 6.5870453270369698 6.1134436050332894 51.31530655377923 ;
	setAttr ".r" -type "double3" -3.600000000000056 15.200000000026455 1.0299547662146118e-016 ;
	setAttr ".rpt" -type "double3" -7.1333408261519277e-017 2.0157882036833516e-016 
		-1.0978997922899275e-017 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 52.338688605578653;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -7.2989306449890137 2.498950719833374 -0.0074615776538848877 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	setAttr ".t" -type "double3" -7.9164762383633942 100.1 -0.48922044169661449 ;
...
createNode transform -s -n "front";
	setAttr ".t" -type "double3" -8.6454857955366773 12.329787124238431 0.0013138991380403787 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".tp" -type "double3" 1.8075547804721395 -0.22821249596415161 0 ;
	setAttr ".hc" -type "string" "viewSet -s %camera";
	setAttr ".o" yes;
createNode transform -n "nurbsCube1";
	setAttr ".t" -type "double3" 0.023094188085407197 -5.7687786990074654 0 ;
	setAttr ".s" -type "double3" 1 1 9.9999999999999998e-013 ;
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" 1.8057405537607787 -0.46215275097624575 0 ;
	setAttr ".r" -type "double3" 90 0 -33.102762147347931 ;
	setAttr ".s" -type "double3" 28.153421675668717 1 3.6825628148031186 ;
...
createNode transform -n "polySurface1";
	setAttr ".t" -type "double3" 0 0.32410113145653607 0 ;
...
createNode mesh -n "polySurfaceShape14" -p "polySurface14";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
parent -s -nc -r -add "|pPlane1|transform2|pPlaneShape1" "transform1" ;
...
createNode polyExtrudeFace -n "polyExtrudeFace1";
	...
	setAttr ".ix" -type "matrix" 23.583907057926165 -15.37577575054714 0 0 5.5511151231257827e-017 1.1102230246251565e-016 1 0
		 -2.0112034934869598 -3.0848548414401153 4.0884660266228486e-016 0 1.8057405537607787 -0.46215275097624575 0 1;
	setAttr ".ws" yes;
	...
	setAttr ".cbx" -type "double3" 13.671225000798547 8.575154892621013 1.1102235570075145e-016 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace2";
	...
	setAttr ".kft" no;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -10.327011145002885 -9.0796403959084451 0.24999999999999978 ;
...
createNode polyMergeVert -n "polyMergeVert10";
	...
	setAttr ".ix" -type "matrix" 0.89279474767290323 1.3778079854202649 -0.004295769586740104 0
		 -1.3260890251252304 0.85930760965903019 0.0082802257912850188 0 0.0058203747273170327 -0.00065372250033877836 0.99998284779536406 0
...
createNode polyExtrudeFace -n "polyExtrudeFace4";
	...
	setAttr ".kft" no;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -10.72449942518735 3.9232112470487754 -0.041798094985350212 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace5";
	...
	setAttr ".rs" 46130;
	setAttr ".lt" -type "double3" 9.1600684014921802e-017 1.9168694409543718e-016 1.7893966673267112 ;
	setAttr ".kft" no;
	setAttr ".c[0]"  0 1 1;
...
createNode polyExtrudeFace -n "polyExtrudeFace6";
	...
	setAttr ".rs" 46912;
	setAttr ".lt" -type "double3" -3.1682373772287751e-015 -1.457167719820518e-016 2.1694868649698269 ;
	setAttr ".kft" no;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -12.09035720516059 1.815473081965834 -0.048114992314214684 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace7";
	...
	setAttr ".kft" no;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" -10.617982882661801 -0.0051582158019805036 -0.053570744017578727 ;
...
connectAttr "groupParts2.og" "|pPlane1|transform2|pPlaneShape1.i";
connectAttr "groupId1.id" "|pPlane1|transform2|pPlaneShape1.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "|pPlane1|transform2|pPlaneShape1.iog.og[0].gco"
		;
connectAttr "groupId3.id" "|pPlane2|transform1|pPlaneShape1.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "|pPlane2|transform1|pPlaneShape1.iog.og[0].gco"
		;
connectAttr "groupId2.id" "|pPlane1|transform2|pPlaneShape1.ciog.cog[0].cgid";
connectAttr "groupId4.id" "|pPlane2|transform1|pPlaneShape1.ciog.cog[0].cgid";
...
connectAttr ":initialShadingGroup.mwc" "|pCylinder1|transform4|pCylinderShape1.iog.og[0].gco"
		;
connectAttr "groupId8.id" "|pCylinder2|transform3|pCylinderShape1.iog.og[0].gid"
		;
connectAttr ":initialShadingGroup.mwc" "|pCylinder2|transform3|pCylinderShape1.iog.og[0].gco"
		;
connectAttr "groupId7.id" "|pCylinder1|transform4|pCylinderShape1.ciog.cog[0].cgid"
		;
connectAttr "groupId9.id" "|pCylinder2|transform3|pCylinderShape1.ciog.cog[0].cgid"
		;
...
connectAttr "|pPlane1|transform2|pPlaneShape1.wm" "polyExtrudeFace1.mp";
connectAttr "polyPlane1.out" "polyTweak1.ip";
connectAttr "polyExtrudeFace1.out" "polyExtrudeFace2.ip";
connectAttr "|pPlane1|transform2|pPlaneShape1.wm" "polyExtrudeFace2.mp";
connectAttr "polyTweak2.out" "polyMergeVert1.ip";
connectAttr "|pPlane1|transform2|pPlaneShape1.wm" "polyMergeVert1.mp";
connectAttr "polyExtrudeFace2.out" "polyTweak2.ip";
connectAttr "polyMergeVert1.out" "polyMergeVert2.ip";
connectAttr "|pPlane1|transform2|pPlaneShape1.wm" "polyMergeVert2.mp";
connectAttr "polyMergeVert2.out" "polyMergeVert3.ip";
connectAttr "|pPlane1|transform2|pPlaneShape1.wm" "polyMergeVert3.mp";
connectAttr "polyMergeVert3.out" "polyMergeVert4.ip";
connectAttr "|pPlane1|transform2|pPlaneShape1.wm" "polyMergeVert4.mp";
connectAttr "polyMergeVert4.out" "polyMergeVert5.ip";
connectAttr "|pPlane1|transform2|pPlaneShape1.wm" "polyMergeVert5.mp";
connectAttr "polyMergeVert5.out" "polyMergeVert6.ip";
connectAttr "|pPlane1|transform2|pPlaneShape1.wm" "polyMergeVert6.mp";
connectAttr "polyMergeVert6.out" "polyMergeVert7.ip";
connectAttr "|pPlane1|transform2|pPlaneShape1.wm" "polyMergeVert7.mp";
connectAttr "polyMergeVert7.out" "polyMergeVert8.ip";
connectAttr "|pPlane1|transform2|pPlaneShape1.wm" "polyMergeVert8.mp";
connectAttr "|pPlane1|transform2|pPlaneShape1.o" "polyUnite1.ip[0]";
connectAttr "|pPlane1|transform2|pPlaneShape1.o" "polyUnite1.ip[1]";
connectAttr "|pPlane1|transform2|pPlaneShape1.wm" "polyUnite1.im[0]";
connectAttr "|pPlane2|transform1|pPlaneShape1.wm" "polyUnite1.im[1]";
...
connectAttr "|pCylinder1|transform4|pCylinderShape1.wm" "polyMergeVert10.mp";
...
connectAttr "|pCylinder1|transform4|pCylinderShape1.wm" "polyExtrudeFace3.mp";
connectAttr "deleteComponent6.og" "polyTweak4.ip";
connectAttr "polyTweak5.out" "polyExtrudeFace4.ip";
connectAttr "|pCylinder1|transform4|pCylinderShape1.wm" "polyExtrudeFace4.mp";
connectAttr "polyExtrudeFace3.out" "polyTweak5.ip";
connectAttr "polyExtrudeFace4.out" "polyExtrudeFace5.ip";
connectAttr "|pCylinder1|transform4|pCylinderShape1.wm" "polyExtrudeFace5.mp";
connectAttr "polyExtrudeFace5.out" "polyExtrudeFace6.ip";
connectAttr "|pCylinder1|transform4|pCylinderShape1.wm" "polyExtrudeFace6.mp";
connectAttr "polyExtrudeFace6.out" "polyExtrudeFace7.ip";
connectAttr "|pCylinder1|transform4|pCylinderShape1.wm" "polyExtrudeFace7.mp";
...
connectAttr "|pCylinder1|transform4|pCylinderShape1.wm" "polyMergeVert11.mp";
connectAttr "deleteComponent14.og" "polyTweak7.ip";
connectAttr "polyTweak8.out" "polyMergeVert12.ip";
connectAttr "|pCylinder1|transform4|pCylinderShape1.wm" "polyMergeVert12.mp";
connectAttr "polyMergeVert11.out" "polyTweak8.ip";
connectAttr "polyMergeVert12.out" "polyMergeVert13.ip";
connectAttr "|pCylinder1|transform4|pCylinderShape1.wm" "polyMergeVert13.mp";
connectAttr "polyTweak9.out" "polyMergeVert14.ip";
connectAttr "|pCylinder1|transform4|pCylinderShape1.wm" "polyMergeVert14.mp";
connectAttr "polyMergeVert13.out" "polyTweak9.ip";
connectAttr "polyTweak10.out" "polyMergeVert15.ip";
connectAttr "|pCylinder1|transform4|pCylinderShape1.wm" "polyMergeVert15.mp";
connectAttr "polyMergeVert14.out" "polyTweak10.ip";
connectAttr "polyTweak11.out" "polyMergeVert16.ip";
connectAttr "|pCylinder1|transform4|pCylinderShape1.wm" "polyMergeVert16.mp";
...
connectAttr "|pCylinder1|transform4|pCylinderShape1.o" "polyUnite2.ip[0]";
connectAttr "|pCylinder1|transform4|pCylinderShape1.o" "polyUnite2.ip[1]";
connectAttr "|pCylinder1|transform4|pCylinderShape1.wm" "polyUnite2.im[0]";
connectAttr "|pCylinder2|transform3|pCylinderShape1.wm" "polyUnite2.im[1]";
...
connectAttr "|pPlane1|transform2|pPlaneShape1.iog.og[0]" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|pPlane1|transform2|pPlaneShape1.ciog.cog[0]" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|pPlane2|transform1|pPlaneShape1.iog.og[0]" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|pPlane2|transform1|pPlaneShape1.ciog.cog[0]" ":initialShadingGroup.dsm"
		 -na;
...
connectAttr "|pCylinder1|transform4|pCylinderShape1.ciog.cog[0]" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|pCylinder2|transform3|pCylinderShape1.iog.og[0]" ":initialShadingGroup.dsm"
		 -na;
connectAttr "|pCylinder2|transform3|pCylinderShape1.ciog.cog[0]" ":initialShadingGroup.dsm"
		 -na;
