...
//Name: Axt_01.ma
//Last modified: Wed, Oct 24, 2012 04:50:13 PM
//Codeset: 1252
requires maya "2013";
...
createNode transform -s -n "persp";
	setAttr ".t" -type "double3" 26.889053281713515 86.3363015495989 324.37251944543021 ;
	setAttr ".r" -type "double3" -14.400000000002466 1085.9999999998267 0 ;
	setAttr ".rpt" -type "double3" -7.1333408261519277e-017 2.0157882036833516e-016 
		-1.0978997922899277e-017 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 335.79665158732172;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -7.2989306449890146 2.498950719833374 -0.0074615776538848877 ;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "groupParts19.og" "AxtShape.i";
connectAttr "groupId31.id" "AxtShape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "AxtShape.iog.og[0].gco";
...
connectAttr "AxtShape.iog.og[0]" ":initialShadingGroup.dsm" -na;
